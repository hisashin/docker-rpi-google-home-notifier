...
sed -e "s/language;/language = req.query.language;/g" -e "s/192.168.1.20/192.168.1.4/g" -e "s/'pl'/'ja'/g" /node_modules/google-home-notifier/example.js > /node_modules/google-home-notifier/app.js
